		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				?>
					...
					<input type="range" class="custom-range" id="inp_kWgaus" name="inp_kWgaus" value="5" min="1" step="2" max=<?php echo '"'.$_SESSION['imgw'].'"'; ?>>
					<label>Height : <span id="spn_kHgaus">5</span></label>
					<input type="range" class="custom-range" id="inp_kHgaus" name="inp_kHgaus" value="5" min="1" step="2" max=<?php echo '"'.$_SESSION['imgh'].'"'; ?>>
